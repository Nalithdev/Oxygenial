...
export const metadata = {
    title: 'Politique de Confidentialité - Medli',
    description: 'Protection des données personnelles et droits RGPD - Medli',
    robots: 'index, follow',
}
...
export default function PolitiqueConfidentialite() {
    return (
        <LegalPage title="Politique de Confidentialité" lastUpdated="19 mai 2026">
            <InformationBox>
                <strong>RGPD :</strong> Medli' accorde une importance capitale à la protection de vos
            ...
            <Section title="1. Responsable de traitement et DPO" id="responsable">
                <Subsection title="Responsable de traitement">
                    <div className="space-y-2 text-gray-700">
                        <p><strong>Nom :</strong> Medli'</p>
                        <p><strong>Email :</strong> contact@Medli'.lunark.dev</p>
                        <p><strong>DPO (Délégué à la Protection des Données) :</strong> dpo@Medli'.lunark.dev</p>
                    </div>
                </Subsection>
            ...
            <Section title="5. Vos droits RGPD" id="droits">
                ...
                <Subsection title="Droit de rectification">
                    <p className="text-gray-700">
                        ...
                        compte ou contactez dpo@Medli'.lunark.dev.
                    </p>
                </Subsection>
                ...
                <Subsection title="Exercice de vos droits">
                    ...
                    <div className="bg-gray-50 p-4 rounded text-gray-700">
                        <p><strong>Email DPO :</strong> dpo@Medli'.lunark.dev</p>
            ...
            <Section title="9. Incidents de sécurité et violations" id="incidents">
                ...
                <Subsection title="Signalement d'incident">
                    ...
                    <p className="text-gray-700">security@Medli'.lunark.dev</p>
                </Subsection>
            ...
            <Section title="10. Consentement et bases légales" id="consentement">
                ...
                <p className="text-gray-700 mt-4">
                    ...
                    révoquer votre consentement en contactant dpo@Medli'.lunark.dev
                </p>
            </Section>
            ...
            <Section title="11. Utilisation par les salariés" id="salaries">
                <Subsection title="Transparence">
                    <p className="text-gray-700 mb-2">
                        Si vous êtes salarié dans une entreprise utilisant Medli', l'entreprise (employeur)
                        doit vous informer :
                    </p>
                    <BulletList
                        items={[
                ...
                <Subsection title="Vos droits">
                    <p className="text-gray-700">
                        ...
                        employeur ou directement auprès du DPO : dpo@Medli'.lunark.dev
                    </p>
                </Subsection>
            </Section>
            ...
            <Section title="12. Modifications de cette politique" id="modifications">
                <Paragraph>
                    Medli' se réserve le droit de modifier cette politique pour se conformer aux
